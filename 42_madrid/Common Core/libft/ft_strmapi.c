...
/*   Updated: 2024/01/19 17:55:56 by rde-migu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include "libft.h"
...
/*
 ...
 - PASO A PASO:
	- Primero se declaran las varialbes que serían i que es el indie que recorre la cadena de entrada,
		str que es el puntero a caracteres para almacenar la nueva cadena resultante y len que sera la longitud de la cadena de entrada.
